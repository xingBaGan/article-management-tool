...
function FolderList({ folders, selectedFolder, onSelectFolder }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full w-64 bg-gray-100 p-4 border-r border-gray-200", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold mb-4", children: "Folders" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: folders.map((folder) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        onClick: () => onSelectFolder(folder),
        className: clsx(
          "w-full flex items-center space-x-2 p-2 rounded-lg transition-colors",
          selectedFolder?.id === folder.id ? "bg-blue-100 text-blue-700" : "hover:bg-gray-200"
        ),
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Folder, { className: "w-5 h-5" }),
...
function ArticleList({ folder, selectedArticle, onSelectArticle }) {
  if (!folder) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full w-72 bg-white p-4 border-r border-gray-200 flex items-center justify-center text-gray-500", children: "Select a folder to view articles" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full w-72 bg-white p-4 border-r border-gray-200", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold mb-4", children: "Articles" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: folder.articles.map((article) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        onClick: () => onSelectArticle(article),
        className: clsx(
          "w-full flex items-center space-x-2 p-2 rounded-lg transition-colors",
          selectedArticle?.id === article.id ? "bg-blue-100 text-blue-700" : "hover:bg-gray-200"
        ),
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-5 h-5" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: article.title })
        ]
      },
      article.id
    )) })
...
function ArticleViewer({ article }) {
  if (!article) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full flex-1 p-4 flex items-center justify-center text-gray-500", children: "Select an article to view its content" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full flex-1 p-6 overflow-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold mb-4", children: article.title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "prose max-w-none", children: article.content })
  ] });
}
...
function DropZone({ onFolderDrop }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      ...getRootProps(),
      className: `fixed inset-0 pointer-events-none ${isDragActive ? "bg-blue-500/20" : ""}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { ...getInputProps() }),
        isDragActive && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center bg-white/80", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center space-y-4 p-8 rounded-lg border-2 border-dashed border-blue-500", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FolderUp, { className: "w-12 h-12 text-blue-500" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-medium text-blue-700", children: "Drop folder here to import" })
        ] }) })
      ]
    }
  );
...
function SettingsModal({ isOpen, onClose }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 flex items-center justify-center z-50", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-[480px] rounded-2xl overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-white/30 backdrop-blur-xl" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold text-gray-900", children: "Settings" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: onClose,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-medium text-gray-900", children: "Theme" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "px-4 py-2 rounded-lg bg-white/50 hover:bg-white/70 transition-colors", children: "Light" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "px-4 py-2 rounded-lg bg-white/50 hover:bg-white/70 transition-colors", children: "Dark" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "px-4 py-2 rounded-lg bg-white/50 hover:bg-white/70 transition-colors", children: "System" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-medium text-gray-900", children: "Editor" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center space-x-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "checkbox", className: "rounded border-gray-300" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-gray-700", children: "Auto-save" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center space-x-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "checkbox", className: "rounded border-gray-300" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-gray-700", children: "Spell check" })
              ] })
            ] })
          ] })
        ] })
...
function App() {
  ...
  const handleFolderDrop = (folderEntries) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-screen flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "h-8 flex items-center bg-red-400 justify-between px-4 select-none",
        style: dragStyle,
        onDoubleClick: () => window.electron?.maximize(),
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white text-sm", children: "Article Publisher" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", style: noDragStyle, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                onClick: () => window.electron?.minimize(),
                className: "p-1 hover:bg-gray-700 rounded",
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Minus, { className: "w-4 h-4 text-gray-300" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                className: "p-1 hover:bg-gray-700 rounded",
                children: isMaximized ? /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { className: "w-4 h-4 text-gray-300" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Square, { className: "w-4 h-4 text-gray-300" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-4 h-4 text-gray-300" })
              }
            )
          ] })
        ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex relative", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ArticleViewer, { article: selectedArticle }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DropZone, { onFolderDrop: handleFolderDrop }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          onClick: () => setIsSettingsOpen(true),
          className: "absolute bottom-4 left-4 p-2 rounded-lg bg-gray-100 hover:bg-gray-200 transition-colors",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { className: "w-5 h-5 text-gray-700" })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        SettingsModal,
